...
scene = SceneConfig(
    ...
    snr_db=20.0,
    targets=[
        TargetSpec(id=1, initial_range=30, initial_velocity=-8, initial_angle=-5,
                   motion=MotionModel(motion="constant_velocity")),
        TargetSpec(id=2, initial_range=25, initial_velocity=13, initial_angle=10,
                   motion=MotionModel(motion="constant_velocity")),
        TargetSpec(id=2, initial_range=20, initial_velocity=10, initial_angle=15,
                   motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=20, initial_velocity=5, initial_angle=20,
        #            motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=15, initial_velocity=-10, initial_angle=0,
        #            motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=15, initial_velocity=10, initial_angle=180,
        #            motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=20, initial_velocity=-8, initial_angle=45,
        #            motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=20, initial_velocity=8, initial_angle=-45,
        #            motion=MotionModel(motion="constant_velocity")),
        # TargetSpec(id=2, initial_range=10, initial_velocity=6, initial_angle=90,
        #            motion=MotionModel(motion="constant_velocity")),
    ],
)
